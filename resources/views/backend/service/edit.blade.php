...
@section('content')
    <div class="container-fluid">
        <!-- SELECT2 EXAMPLE -->
        <form action="{{url('admin/update-service/'.$service->id)}}" method="POST" enctype="multipart/form-data" class="form-control">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Image*</label>
                                <input type="file" accept="image/*" name="image" value="{{$service->image}}" class="form-control"
                                    required>
                            </div>
                            <img class="mb-2" src="{{asset('backend/images/service/'.$service->image)}}" height="50" width="50">
                        </div>
